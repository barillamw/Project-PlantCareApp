...
import kotlinx.android.synthetic.main.activity_fourth_plant.*
...
class FourthPlant : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_fourth_plant)
        ...
        waterButton.setOnClickListener {
            Toast.makeText(this@FourthPlant, "You watered your plant!", Toast.LENGTH_SHORT).show()
            val arg = "pump/on/4\n"
